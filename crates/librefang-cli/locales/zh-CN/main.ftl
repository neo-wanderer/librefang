...
chat-runner-session-reset = 会话已重置 — 重新开始。
chat-runner-session-reset-failed = 无法重置会话。
...
tui-mod-help-new = /new          — 重置会话（重新开始）
...
tui-mod-session-reset = 会话已重置 — 重新开始。
tui-mod-session-reset-failed = 无法重置会话。
